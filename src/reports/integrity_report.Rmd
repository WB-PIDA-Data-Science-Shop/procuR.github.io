...
# FIXED: Helper to access nested module results
print_result_plot <- function(results,
  ...
  if (inherits(obj, "gg")) {
    ...
    # Something exists but is not a ggplot
